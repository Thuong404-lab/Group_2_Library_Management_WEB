 ...
 */
ALTER TABLE dbo.Member_Accounts DROP CONSTRAINT FK_Member_Accounts_language;
ALTER TABLE dbo.Notifications DROP CONSTRAINT FK_Notifications_language;
ALTER TABLE dbo.MembershipTierTranslations DROP CONSTRAINT FK_MembershipTierTranslations_language;
