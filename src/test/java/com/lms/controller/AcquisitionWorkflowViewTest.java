...
class AcquisitionWorkflowViewTest {
        ...
        void rendersStandardizedMemberInteractionPagesWithCurrentDatabase() throws Exception {
                ...
                mockMvc.perform(get("/member/interaction/acquisition-requests/new").with(user(memberUser)))
                                ...
                                .andExpect(content().string(org.hamcrest.Matchers
                                                .containsString("data-target=\"#acquisitionRequestModal\"")))
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("id=\"acquisitionRequestModal\"")))
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("id=\"acquisitionRequestForm\"")));
                ...
                mockMvc.perform(get("/member/borrow/management")
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("id=\"renewConfirmModal\"")));
                mockMvc.perform(get("/member/borrow/management")
                                .param("tab", "reserved")
                                .with(user(memberUser)))
                                .andExpect(status().isOk())
                ...
                mockMvc.perform(get("/member/cart").with(user(memberUser)))
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("member-account-dropdown")))
                                .andExpect(content()
                                                .string(org.hamcrest.Matchers.containsString("href=\"/member/cart\"")));
                mockMvc.perform(get("/member/borrow/reservations").with(user(memberUser)))
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("member-reservations-hero")))
                ...
                mockMvc.perform(get("/books/{id}", availableBookId)
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("action=\"/member/cart/add\"")));
                ...
                mockMvc.perform(get("/member/cart")
                                ...
                                .andExpect(status().isOk())
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString(availableBook.get().getTitle())));
                mockMvc.perform(post("/member/cart/add")
                                .param("bookId", String.valueOf(availableBookId))
                                .session(cartSession)
                                .with(user(memberUser))
                ...
                mockMvc.perform(get("/member/cart/checkout")
                                ...
                                .andExpect(content()
                                                .string(org.hamcrest.Matchers.containsString("member-checkout-layout")))
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("action=\"/member/cart/submit\"")))
                                .andExpect(content()
                                                .string(org.hamcrest.Matchers.containsString("name=\"numberOfDays\"")))
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("name=\"selectedBookIds\"")));
                mockMvc.perform(get("/member/cart/checkout")
                ...
                mockMvc.perform(get("/member/cart")
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("action=\"/member/cart/remove\"")))
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("name=\"selectedBookIds\"")));
                mockMvc.perform(get("/member/borrow/create")
                                ...
                                .andExpect(content().string(
                                                org.hamcrest.Matchers.containsString("member-borrow-create-hero")))
                                .andExpect(content().string(org.hamcrest.Matchers
                                                .containsString("action=\"/member/borrow/request/submit\"")))
                                .andExpect(content()
                                                .string(org.hamcrest.Matchers.containsString("name=\"numberOfDays\"")));
        ...
        void rendersLibrarianOperationalDashboard() throws Exception {
                mockMvc.perform(get("/librarian/dashboard"))
                                ...
                                .andExpect(content()
                                                .string(org.hamcrest.Matchers.containsString("Tasks Awaiting Action")));
        }
